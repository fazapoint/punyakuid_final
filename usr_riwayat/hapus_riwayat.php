...
if ($hapus) {
    ...
    echo "<script>alert('Data berhasil dihapus');window.location='../user/usr_riwayat.php';</script>";
} else {
    echo "<script>alert('Data Gagal Di Hapus, Coba ulangi lagi');window.location='../user/usr_riwayat.php';</script>";
}
