...
if (isset($_POST['edit'])) {
    ...
    if ($foto_user != "") {
        ...
        if (in_array($ekstensi, $ekstensi_boleh) === false) {
            echo "<script>alert('Ekstensi foto tidak diperbolehkan');window.location='../admin/adm_user.php';</script>";
        } elseif ($ukuran >= $maxsize || $ukuran == 0) {
            echo "<script>alert('Ukuran foto adalah 1MB');window.location='../admin/adm_user.php';</script>";
            ...
            echo "<script>alert('Data berhasil diupdate');window.location='../admin/adm_user.php';</script>";
        } else {
